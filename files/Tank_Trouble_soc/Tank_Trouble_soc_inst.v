	Tank_Trouble_soc u0 (
		...
		.walls_addr_export              (<connected-to-walls_addr_export>),              //              walls_addr.export
		.walls_data_export              (<connected-to-walls_data_export>),              //              walls_data.export
		.walls_we_export                (<connected-to-walls_we_export>),                //                walls_we.export
		.screen_reset_export            (<connected-to-screen_reset_export>)             //            screen_reset.export
	);
