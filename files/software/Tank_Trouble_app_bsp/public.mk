...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../Tank_Trouble_soc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is Tank_Trouble_soc
SOPC_NAME := Tank_Trouble_soc
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x80011f8
SOPC_SYSID_FLAG += --sidp=0x80011f8
ELF_PATCH_FLAG  += --sidp 0x80011f8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1651454467
SOPC_SYSID_FLAG += --timestamp=1651454467
ELF_PATCH_FLAG  += --timestamp 1651454467
